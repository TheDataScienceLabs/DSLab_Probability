...
from max30102 import (
    MAX30105_PULSE_AMP_LOWEST,
    MAX30105_PULSE_AMP_LOW,
...
def main():
    ...
    # I2C instance
    i2c = SoftI2C(sda=Pin(my_SDA_pin), scl=Pin(my_SCL_pin), freq=my_i2c_freq)
    ...
    # Set the sample rate
    SAMPLE_RATE = (
        200  # int(input('SAMPLE_RATE = ')) # Set the variable value by the user.
    )
    sensor.set_sample_rate(SAMPLE_RATE)
    ...
    while True:
        ...
        if sensor.available():
            ...
            print(
                -red_reading + 30000
            )  # it is IR in the sensor purchased, it can be different in other sensor
